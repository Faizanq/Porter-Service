...
<div class="">
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Drivers <a href="{{route('drivers.create')}}" class="btn btn-primary btn-xs"><i class="fa fa-plus"></i> Create New </a></h2>
                ...
                <div class="x_content">
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                        ...
                        @endif                                
                                <td>
                                     <a href="{{ route('drivers.profile', ['id' => $row->id]) }}" class="btn btn-info btn-xs"><i class="icon-eye" title="View"></i> </a>

                                    <a href="{{ route('drivers.edit', ['id' => $row->id]) }}" class="btn btn-info btn-xs"><i class="icon-pencil" title="Edit"></i> </a>
                                    <a href="{{ route('drivers.show', ['id' => $row->id]) }}" class="btn btn-danger btn-xs"><i class="icon-bin" title="Delete"></i> </a>
                                </td>
                            </tr>
                            @endforeach
                            @endif
