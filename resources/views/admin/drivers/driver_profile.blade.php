...
<div class="row">
      <div class="col-xs-12 col-sm-9">
        ...
        <div class="panel panel-default">
          ...
          @if($driver->profile_image != null && $driver->profile_image !='')
            @php
          ...
          <div class="panel-body">
            ...
            <div class="profile__header">
              <h4>{{$driver->full_name}}<small></small></h4>
              <p class="text-muted">
                @if(!empty($driver->about))
                  {{$driver->about}}
                @else
                  {{'No description'}}
                @endif
        ...
        <div class="profile__contact-info">
          <div class="profile__contact-info-item">
            ...
            <div class="profile__contact-info-body">
              ...
              @if(!empty($driver->contact_number))
              ({{$driver->country_code}}){{$driver->contact_number}}
              @else
              {{'Not provided'}}
              @endif
            </div>
